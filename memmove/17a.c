...
void CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67_bad(char * source)
{
    char * data;
    ...
    CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67b_badSink(myStruct, source);
}
...
static void goodG2B(char * source)
{
    ...
    data[0] = '\0'; /* null terminate */
    myStruct.structFirst = data;
    CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67b_goodG2BSink(myStruct, source);
}

void CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67_good(char * source)
{
    goodG2B(source);
}
...
int main(int argc, char * argv[])
{
    ...
    CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67_good(buffer);
    printLine("Finished good()");
#endif /* OMITGOOD */
#ifndef OMITBAD
    printLine("Calling bad()...");
    CWE121_Stack_Based_Buffer_Overflow__CWE805_char_declare_memmove_67_bad(buffer);
